...
// **Añadida ruta de logout**
Route::post('/logout', [UsuarioController::class, 'logout'])->name('logout');

Route::get('/registro', function () {
    return view('registro');
})->name('registro');
Route::post('/registro', [UsuarioController::class, 'store'])->name('registro.attempt');
...
// Rutas de contacto de cliente, mesas, alérgenos y líneas de pedido
